...
SECRET_KEY = 'django-insecure-=i%i5c(q8vnevt@vii3u_*m6az_^&x#&qfa)aycf_tu&xn$&tg'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['128.199.202.228', 'fwb.thammasat.online.th', '127.0.0.1']
...
CSRF_TRUSTED_ORIGINS = ['https://fwb.thammasat.online.th']
